...
3. (Achieved on 2020.12.16) 优化【博客文章列表】中元素的显示。

### v5.0.110 (2021.1.22) by oistream

（v5.0.111 与此是同一版本）

1. (Achieved on 2021.1.22) 增加【好友 / 个人信息】配置，并且改进了相关显示样式。
2. (Achieved on 2021.2.7) 优化【推荐网站】功能（即原【今天去哪儿】），并增加了配置其中网站与显示图片的渠道。
